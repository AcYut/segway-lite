...
void Hand::init()
{
	...
	if(hand==LEFT)
	{
		pos[0]=4096-2172;		// pos[0]=2048;
		pos[1]=4096-1040;	// pos[1]=3071;
		pos[2]=1792;		// pos[2]=1792;
		pos[3]=4096-2198;	// pos[3]=4096-2048;
	}
	else
	{
		pos[0]=2172;		// pos[0]=2048;
		pos[1]=1040;		// pos[1]=4096-3071;
		pos[2]=4096-1792;	// pos[2]=4096-1792;
		pos[3]=2048;		// pos[3]=2048;
	}
