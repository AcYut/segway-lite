...
int main()
{
	...
	// LEFT HAND
	float mot07[]={4096-2048,4096-2048,4096-2048,4096-2048,4096-2048};
	float mot08[]={4096-1100,4096-1100,4096-1100,4096-1100,4096-1100};
	float mot10[]={4096-2048,4096-2048,4096-2048,4096-2048,4096-2048};
	
	//RIGHT HAND
	float mot27[]={2048,2048,3072,2048,2048};
	float mot28[]={1100,2048,2048,1100,1100};
	float mot30[]={2048,3300,3300,2048,2048};

	//LEFT LEG
	float llegx[]={390,390,390,390,390};
	float llegy[]={0,0,0,0,0};
	float llegz[]={0,0,0,0,0};
	
	//RIGHT LEG
	float rlegx[]={390,390,390,390,390};
	float rlegy[]={0,0,0,0,0};
	float rlegz[]={0,0,0,0,0};
